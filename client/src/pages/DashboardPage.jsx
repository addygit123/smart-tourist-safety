          ...
          <main className="flex-grow flex p-4 gap-4 overflow-hidden">
            ...
            <div className="flex-[3] flex flex-col gap-4">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <StatisticsCard title="Total Tourists" value="1,204" color="text-blue-400" />
                <StatisticsCard title="Anomalies Detected" value="3" color="text-orange-400" />
                <StatisticsCard title="Active Alerts (SOS)" value="1" color="text-red-500" />
